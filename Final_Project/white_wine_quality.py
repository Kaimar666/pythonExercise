...
data_url = r"C:/Users/81275/.keras/datasets/wine_red/wine_white.xlsx"
...
#输入数据
history = model.fit(x_train, y_train, batch_size=64, epochs=500, validation_split=0.05, validation_freq=1, callbacks=[cp_callback])

#打印计算图
model.summary()

#参数提取
file=open('./white_weights.txt','w')
